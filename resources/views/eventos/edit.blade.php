...
<head>
    ...
    <title>Editar Evento - Reforesta</title>
            ...
            <div class="form-contenido">
                ...
                <form action="{{ route('eventos.update', $evento) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="4" required>{{ old('descripcion', $evento->descripcion) }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="ubicacion">Ubicación *</label>
                        <input type="text" id="ubicacion" name="ubicacion" value="{{ old('ubicacion', $evento->ubicacion) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="tipo_terreno">Tipo de terreno *</label>
                        <input type="text" id="tipo_terreno" name="tipo_terreno" value="{{ old('tipo_terreno', $evento->tipo_terreno) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="tipo_evento">Tipo de evento *</label>
                        <input type="text" id="tipo_evento" name="tipo_evento" value="{{ old('tipo_evento', $evento->tipo_evento) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="fecha">Fecha del evento *</label>
                        <input type="date" id="fecha" name="fecha" value="{{ old('fecha', $evento->fecha) }}" required>
                    </div>
                    ...
                    <div style="margin-top: 30px;">
                        ...
                        <a href="{{ route('eventos.show', $evento) }}" class="btn-cancelar">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
